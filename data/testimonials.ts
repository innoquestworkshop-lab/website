...
export const testimonials: Testimonial[] = [
  {
    ...
    role: "Student",
    context: ["Break the Market Vol.1", "Assumption College Sriracha Panel Discussion"],
    stars: 5,
  ...
  },
  {
    ...
    name: "Mike",
    role: "Student",
    context: "Swipe Next Gen Summer Camp · Assumption College Series",
    stars: 5,
  ...
  },
  {
    ...
    role: "Student",
    context: "Assumption College Sriracha Panel Discussion",
    stars: 5,
  ...
  },
  {
    ...
    role: "Teacher · Assumption College Sriracha",
  ...
  },
  {
    ...
    audience: "corporate",
    quote:
      "A huge thank you to Team InnoQuest for supporting Swipe Next Gen through the finance sessions. Working with the team was smooth and comfortable throughout the process — everyone was very friendly, approachable, and well-prepared. The coordination, detailed agenda, and organized system made everything easy to manage and collaborate on. During the sessions, the team was able to balance both insightful content and fun interactions, which kept the students engaged, active, and genuinely excited to learn.",
    name: "Swipe Next Gen",
    role: "Partner Organization",
    context: "Swipe Next Gen Summer Camp · Finance Sessions",
    stars: 5,
    avatar: "/images/testimonials/swipe-next-gen-logo.jpg",
    tag: "Corporate",
  },
  {
    id: "t16",
    audience: "student",
    quote:
      "ค่าย innoquest เป็นค่ายที่ทั้งสนุกแล้วก็ได้ความรู้เยอะมากมากเลย เพราะพี่พี่พาทำ workshop ที่สนุกแต่ก็ยังได้ประโยชน์ แล้วก็ได้ฟังประสบการ์ณจากคนที่ทำ business จริงๆ ทำให้ได้เห็นหลายมุมมอง การมาค่าย innoquest ทั้งแฮปปี้แล้วก็ได้พัฒนาตัวเองไปด้วยย แล้วพี่พี่ทุกคนใน innoquest ก็น่ารักมากและพร้อมที่จะช่วยอยุ่ตลอด <3 innoquest and pp tookkhon 🩶.",
    name: "Ulie",
    role: "Student",
    context: "Entrepreneur in Innovation",
    stars: 5,
    avatar: "/images/testimonials/ulie.jpg",
    programSlug: "entrepreneur-in-innovation",
  },
];
